...
**5th SSOT**: 본 문서는 [ROLES/planner.md](../ROLES/planner.md), [SUB-SSOT/PLANNER/1-planning-procedure.md](../SUB-SSOT/PLANNER/1-planning-procedure.md)와 함께 사용. 단독 사용 시 본 docs/SSOT 세트만 참조.
