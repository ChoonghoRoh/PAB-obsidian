...
**적용**: Agent Teams 팀원( subagent_type: "Explore", model: "opus 계열 최신" )
...
|------|------|
| **팀원 이름** | `research-architect` |
| **팀 스폰** | Task tool -> `team_name: "phase-X-Y"`, `name: "research-architect"`, `subagent_type: "Explore"`, `model: "opus 계열 최신"` |
