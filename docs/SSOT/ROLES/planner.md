...
**버전**: 7.0-renewal-5th
**팀원 이름**: `planner`
**적용**: Agent Teams 팀원( subagent_type: "Plan", model: "opus 계열 최신" )
...
|------|------|
| **팀원 이름** | `planner` |
| **팀 스폰** | Task tool -> `team_name: "phase-X-Y"`, `name: "planner"`, `subagent_type: "Plan"`, `model: "opus 계열 최신"` |
...
계획 분석 **1회** 시작 시 컨텍스트에 포함 권장: (1) phase-X-Y-status.md (2) master-plan navigation(Team Lead 전달) (3) 본 문서 SSOT 리스크 (4) SUB-SSOT/PLANNER/1-planning-procedure.md.
...
**상세 작업지시**: SUB-SSOT/PLANNER/1-planning-procedure.md
...
| 작업지시 가이드 | SUB-SSOT/PLANNER/1-planning-procedure.md |
