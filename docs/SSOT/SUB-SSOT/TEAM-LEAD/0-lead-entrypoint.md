...
[ ] SUB-SSOT/TEAM-LEAD/2-lifecycle-procedure.md — LIFECYCLE-5/6 상세 (~2K)
[ ] SUB-SSOT/TEAM-LEAD/3-leader-contract.md    — Leader 연계 계약 (~2K)
...
| HR-7 | 에이전트 라이프사이클 관리 (LIFECYCLE-1~6) |
