...
| [`260826-PO4-PO3회답-모집단확정-PR1수용-편입일정.md`](260826-PO4-PO3회답-모집단확정-PR1수용-편입일정.md) | **PAB-obsidian** | 회답본 — 판정 모집단 확정 + **PR-1 수용(결함 실재 확인)** + 편입 일정 | **회답 대기** |
| PO5 | (예정 — Prove) P-1 완료 통지 = **편입 게이트** | 수신본 | 대기 |
...
| **PR-2 판정** | 판정 모집단 = **`10_Notes` + `15_Sources`**(화이트리스트). Observer `#26` 관측 모집단과 일치시켜 3자가 같은 것을 센다. `00_MOC`는 **판정 대상이 아니라 판정 근거** |
